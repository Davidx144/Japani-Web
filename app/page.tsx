...
export default function LandingPage() {
  return (
    <div className="flex flex-col min-h-dvh bg-japan-white dark:bg-japan-black">
      <header className="px-4 lg:px-12 h-20 flex items-center border-b border-gray-800 w-full">
        <JapanRacerLogo />
      ...
      <main className="flex-1 w-full">
        ...
        >
          <div className="w-full px-4 md:px-6 bg-black/70 py-16 rounded-md">
              ...
              <div className="flex flex-col justify-center items-center space-y-4 text-center">
                <div className="space-y-2">
                  <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-japan-white">
                    Todo tu ecosistema de repuestos, en una sola plataforma.{" "}
                    <span className="text-japan-red">Japani Racer</span>
                  </h1>
                  <p className="max-w-[700px] mx-auto text-gray-300 md:text-xl">
                    Desde talleres hasta distribuidores, JAPANI DIGITAL conecta
                    todos los actores del negocio con tecnología, velocidad y
                    precisión.
                  </p>
                </div>
            ...
            <div className="w-full flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-600 dark:text-gray-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Nuestra plataforma está diseñada para potenciar su negocio con
                  herramientas de vanguardia para ventas, logística y gestión de
                  clientes.
                </p>
              </div>
            </div>
            <div className="w-full grid items-start gap-8 sm:grid-cols-2 md:gap-12 lg:grid-cols-3 lg:gap-16 mt-12">
              <div className="grid gap-2 p-4 rounded-lg border border-gray-700 hover:shadow-xl transition-shadow bg-white dark:bg-black">
                ...
                <h3 className="text-xl font-bold text-japan-black dark:text-japan-white">
                  Comercio Electrónico B2B
                </h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Catálogo filtrable, pedidos fáciles y gestión de cuentas de
              ...
              <div className="grid gap-2 p-4 rounded-lg border border-gray-700 hover:shadow-xl transition-shadow bg-white dark:bg-black">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Seguimiento de envíos en vivo, confirmaciones de entrega y
                  gestión eficiente de rutas para mensajeros.
                </p>
              </div>
              <div className="grid gap-2 p-4 rounded-lg border border-gray-700 hover:shadow-xl transition-shadow bg-white dark:bg-black">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Sincronización perfecta con Odoo, SAP, CIBO para la gestión de
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t border-gray-800">
        <p className="text-xs text-gray-500 dark:text-gray-400">
          &copy; {new Date().getFullYear()} Corredor de Japón. Todos los
          derechos reservados.
        </p>
